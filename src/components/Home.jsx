...
const Home = () => {
  return (
    <div name='home' className='w-full flex flex-col md:flex-row items-center justify-center md:justify-evenly h-screen pt-24 px-6 md:px-28 bg-[#0a192f]'>
      {/* Image Container */}
      <div className='flex-shrink-0'>
        <img className='w-full md:max-w-[450px] h-auto rounded-full' src={person} alt="yogesh" />
      </div>
      {/* Text Content */}
      <div className='md:max-w-[800px] md:mx-0 flex flex-col justify-center h-full'>
        ...
        <p className='text-[#8892b0] py-4 text-xl'>
